...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Greeter = React.createClass({
	  ...
	  handleNewState: function handleNewState(state) {
	    this.setState(state);
	  },
	  render: function render() {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(GreeterForm, { onNewState: this.handleNewState })
	    );
	  }
	});
	...
	ReactDOM.render(React.createElement(Greeter, { name: firstName, message: myComp }), document.getElementById('app'));
